...
func firstWindow() {
	...
	ui.Text("teп-tt214332423", "fqsvp qлу,", ui.Selectable)
	...
	ui.VSpace("Sadws34")
	ui.Selection("sel-1u65", &selection, sle, arrowDown.TextureId, arrowDown.TexCoords)
	ui.VSpace("adadf")
	if ui.GET_CONTEXT().ActiveWidget == "#eывr" {
